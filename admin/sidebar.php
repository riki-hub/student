<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link text-dark" href="riwayat.php">
      ...
      <li class="nav-item">
        <a class="nav-link text-dark" href="kelas.php">
          <i class="material-symbols-rounded opacity-5">login</i>
          <span class="nav-link-text ms-1">Kelas</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark" href="siswa.php">
          <i class="material-symbols-rounded opacity-5">person</i>
          <span class="nav-link-text ms-1">Siswa</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark" href="jenis_pelanggaran.php">
          <i class="material-symbols-rounded opacity-5">assignment</i>
          <span class="nav-link-text ms-1">Jenis Pelanggaran</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark" href="sanksi.php">
          <i class="material-symbols-rounded opacity-5">assignment</i>
